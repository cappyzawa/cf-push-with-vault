module github.com/cappyzawa/cf-push-with-vault
...
require (
	...
	github.com/cloudfoundry/bosh-utils v0.0.0-20190403233332-6725a40fb9cb // indirect
	...
	github.com/hashicorp/nomad/api v0.0.0-20190405192411-f812e25ac1a7
